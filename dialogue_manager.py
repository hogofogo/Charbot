...
os.chdir('/home/vlad/Documents/natural-language-processing/project')
...
class DialogueManager(object):
    ...
    def create_chitchat_bot(self):
        ...
        self.chitchat_bot = ChatBot('hogofogo',
    ...
    def generate_answer(self, question):
        ...
        feed_question = []
        feed_question.append(prepared_question)
        features = self.tfidf_vectorizer.transform(feed_question) #### YOUR CODE HERE ####
        ...
        # Goal-oriented part:
            ...
            thread_id = thread_ranker.get_best_thread(prepared_question, tag) #### YOUR CODE HERE ####
